...
const modules=[
  ...
  {w:6,c:"ethics",t:"Research Initiation, Procedures, IRB, and Ethics",g:"Research purpose, procedural documentation, IRB preparation, and ethical responsibilities before data collection.",act:"Identify risks related to participants, data collection, privacy, and consent.",as:"Prepare a research procedure table and an initial ethics checklist.",ck:["Are recruitment, consent, and data collection sequenced clearly?","Does the plan include privacy and data storage procedures?","Has the researcher role and potential risk been examined?"],f:"week6-research-problem-procedure-ethics-40slides.pdf"},
  {w:7,c:"writing",t:"Writing from Methods to Conclusion",g:"Quantitative, qualitative, and mixed methods; visualization of findings; and writing functions across results, discussion, and conclusion sections.",act:"Use one table or figure to draft a results paragraph and a discussion paragraph.",as:"Submit five interpretive results sentences and one discussion paragraph.",ck:["Do results sentences describe key patterns accurately?","Does the discussion connect findings to previous research?","Does the conclusion present contribution and limitations without overstatement?"],f:"week7-methodology-results-writing-functions-40slides.pdf"},
  ...
  {w:9,c:"writing",t:"Visual Evidence, Recommendations, Limitations, and Academic Language",g:"Referencing tables and figures, writing recommendations and limitations, and using cautious academic language.",act:"Write three sentences that refer to a table or figure and two sentences that state limitations.",as:"Submit one paragraph that interprets visual evidence and one limitation paragraph.",ck:["Are tables and figures referenced by number and key pattern?","Are limitations presented in a balanced manner?","Are causal claims and cautious expressions distinguished?"],f:"week9-visual-references-recommendations-academic-language-40slides.pdf"},
